                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                               <div class="btn-group" style="margin-bottom:2%">
                                                    ...
                                                    data-target="#dept" data-tooltip="true" data-toggle="modal" title="Add a Student" >  <i class="fa fa-plus"></i> Create New Student
                    ...
                    <div  class="modal fade myModal" role="dialog">
                        <div class="modal-dialog"> 
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="mode9"> </div>
          ...
          <div class="modal-body" style="padding:5%">	
                        ...
                        <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="sname"  placeholder="Enter Student Lastname" required/>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="email" class="form-control" name="email"  placeholder="Enter Student Email Address" required/>
								</div>
							</div>
						</div>
                        <div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" autocomplete="false" name="password"  placeholder="Enter Student  Password" required/>
								</div>
							</div>
						</div>
