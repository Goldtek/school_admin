                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                               <div class="btn-group" style="margin-bottom:2%">
                                                    ...
                                                    data-target="#dept" data-tooltip="true" data-toggle="modal" title="Create Course" >  <i class="fa fa-plus"></i> Create New Course
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" onclick="dept()" data-name="{{$dept->name}}" data-active="{{$dept->active}}" data-id="{{$dept->id}}" data-tooltip="true" data-toggle="modal" data-placement="top" title="Edit Course" data-target=".dept">
                                                                    <i class="fa fa-pencil"></i> Edit Course </a>
                                                            </li>
        ...
        <!-- beginning of modal body -->
          <div class="modal-body" style="padding:5%">	
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Name Of Course</label>
...
<div class="modal fade dept" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-header" style="background-color:#f1c40f; color:#fff;font-weight:bold">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h4 class="modal-title custom_align" id="Heading">Update Course</h4>
    </div>
