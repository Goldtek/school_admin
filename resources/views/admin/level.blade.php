                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                               <div class="btn-group" style="margin-bottom:2%">
                                                    ...
                                                    data-target="#dept" data-tooltip="true" data-toggle="modal" title="Create Level" >  <i class="fa fa-plus"></i> Create New Level
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" onclick="dept()" data-name="{{$dept->name}}" data-active="{{$dept->active}}" data-id="{{$dept->id}}" data-tooltip="true" data-toggle="modal" data-placement="top" title="Edit Level" data-target=".dept">
                                                                    <i class="fa fa-pencil"></i> Edit Level </a>
                                                            </li>
    ...
    <div class="modal-content">               
 	...
 	<form class="form-horizontal" method="post" action="" id="createDept">	
        <div class="modal-header" style="background-color: #32c5d2; color: #fff;font-weight:bold">
            ...
            <h4 class="modal-title custom_align" id="Heading">Create New Level</h4>
      </div>
        
        <!-- beginning of modal body -->
          <div class="modal-body" style="padding:5%">	
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Name Of Level</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-th-large fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="name" id="deptname"  placeholder="Enter Course Name" required/>
								</div>
							</div>
						</div>
